...
<div class="home-register">
    ...
    <div class="home-register__content">
        <img src="<?php $this->asset("img/home/logo-floresta-ativista.png") ?>"/>
        ...
        <a v-if="global.auth.isGuest" href="<?= $app->createUrl('auth') ?>" class="home-register__content--button button button--icon button--bg">
            <?= i::__('Fazer Cadastro')?>
