...
return array(
    ...
    'items' => array(
        ...
        25 => array( 'name' => \MapasCulturais\i::__("Inscrições")),
        26 => array( 'name' => \MapasCulturais\i::__("Pesquisa")),
        27 => array( 'name' => \MapasCulturais\i::__("Consulta")),
        28 => array( 'name' => \MapasCulturais\i::__("Ato público")),
        29 => array( 'name' => \MapasCulturais\i::__("Aulão")),
        30 => array( 'name' => \MapasCulturais\i::__("Campeonato")),
        31 => array( 'name' => \MapasCulturais\i::__("Cobertura")),
        32 => array( 'name' => \MapasCulturais\i::__("Conferência")),
        33 => array( 'name' => \MapasCulturais\i::__("Convocatória")),
        34 => array( 'name' => \MapasCulturais\i::__("Debate")),
        35 => array( 'name' => \MapasCulturais\i::__("Espetáculo de Dança")),
        36 => array( 'name' => \MapasCulturais\i::__("Espetáculo Musical")),
        37 => array( 'name' => \MapasCulturais\i::__("Espetáculo Teatral")),
        38 => array( 'name' => \MapasCulturais\i::__("Estágio ou bolsa")),
        39 => array( 'name' => \MapasCulturais\i::__("Evento de Rua")),
        40 => array( 'name' => \MapasCulturais\i::__("Festa")),
        41 => array( 'name' => \MapasCulturais\i::__("Freela")),
        42 => array( 'name' => \MapasCulturais\i::__("Hackathon")),
        43 => array( 'name' => \MapasCulturais\i::__("Happy Hour")),
        44 => array( 'name' => \MapasCulturais\i::__("Imersão")),
        45 => array( 'name' => \MapasCulturais\i::__("Jam")),
        46 => array( 'name' => \MapasCulturais\i::__("Maratona")),
        47 => array( 'name' => \MapasCulturais\i::__("Marcha")),
        48 => array( 'name' => \MapasCulturais\i::__("Mutirão")),
        49 => array( 'name' => \MapasCulturais\i::__("Palestra")),
        50 => array( 'name' => \MapasCulturais\i::__("Performance")),
        51 => array( 'name' => \MapasCulturais\i::__("Prêmio")),
        52 => array( 'name' => \MapasCulturais\i::__("Projeção")),
        ...
        56 => array( 'name' => \MapasCulturais\i::__("Slam")),
        57 => array( 'name' => \MapasCulturais\i::__("Stand Up")),
        58 => array( 'name' => \MapasCulturais\i::__("Vaga de trabalho")),
        59 => array( 'name' => \MapasCulturais\i::__("Vernissage")),
        60 => array( 'name' => \MapasCulturais\i::__("Vivência")),
    )
);
